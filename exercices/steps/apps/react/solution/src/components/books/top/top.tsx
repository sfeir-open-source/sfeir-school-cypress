...
export function Top (props: TopProps) {
  ...
  return user
    ...
    : <div data-cy="top-10-login-placeholder" className="flex justify-around p-8 mx-8 my-4 bg-gray-200 border border-gray-300 rounded-md">
        <HeartIcon className="w-16 h-16"/>
        <div className="flex flex-col">
          <span className="pb-4 text-lg">Let us guess your next favourite books !</span>
          <div>
           <span>Just <Link to="signin">log in</Link>, and enjoy our best books, chosen just for you !</span>
          </div>
        </div>
    </div>
}
